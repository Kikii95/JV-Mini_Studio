...
shield_image = pygame.image.load('img/loutre.png')
...
# Dialogues
dialogues = [
    "«My precious brush! You’ve found it! ",
    "I can finally draw one last time. Stand still, I will give you back your colors.»",
    "You helped me so much… really.",
    "Find the strongest elk in the wild! He knows what happened to you.",
    " He will tell you the story of your old self.",
    "Thanks again little soul, may you find a path through the forest.",

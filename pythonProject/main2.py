...
#background
bg1 = pygame.image.load('img/Background/Bg_3/bg1.png').convert_alpha()
bg1 = resize_image(bg1,2/3 * SCREEN_WIDTH, 4/5 * SCREEN_HEIGHT)
bg2 = pygame.image.load('img/Background/Bg_3/bg2.png').convert_alpha()
bg2 = resize_image(bg2,2/3 * SCREEN_WIDTH, 4/5 * SCREEN_HEIGHT)
bg3 = pygame.image.load('img/Background/Bg_3/bg3.png').convert_alpha()
bg3 = resize_image(bg3,2/3 * SCREEN_WIDTH, 4/5 * SCREEN_HEIGHT)
bg4 = pygame.image.load('img/Background/Bg_3/bg4.png').convert_alpha()
bg4 = resize_image(bg4,2/3 * SCREEN_WIDTH, 4/5 * SCREEN_HEIGHT)
bg5 = pygame.image.load('img/Background/Bg_3/bg5.png').convert_alpha()
...
def draw_bg():
    ...
    for x in range(5):
        ...
        screen.blit(bg4, ((x * width) - bg_scroll * 0.6, (SCREEN_HEIGHT/2 - (bg5.get_height() - 2*offset)) + offset))
        screen.blit(bg3, ((x * width) - bg_scroll * 0.85, (SCREEN_HEIGHT/2 - bg4.get_height()) + offset))
        screen.blit(bg2, ((x * width) - bg_scroll * 1.1, (SCREEN_HEIGHT/2 - bg3.get_height()) + offset))
        screen.blit(bg1, ((x * width) - bg_scroll * 1.35, (SCREEN_HEIGHT/2 - bg2.get_height()) + offset))
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if not inventory.inv_open:
                ...
                if event.key == pygame.K_a:
                    run_external_script('Album2.py')
                if event.key == pygame.K_p:
                    run_external_script('text2.py')

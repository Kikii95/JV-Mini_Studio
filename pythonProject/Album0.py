...
class PhotoAlbum:
    def __init__(self, screen):
        ...
        self.pages = [[(pygame.transform.scale(pygame.image.load(os.path.join(self.image_folder, 'HD.png')), (self.screen_width//3, self.screen_height//3)), (self.screen_width//6 - 50, self.screen_height//4)),
        (pygame.transform.scale(pygame.image.load(os.path.join(self.image_folder, 'HD.png')), (self.screen_width//3, self.screen_height//3)), (self.screen_width//2 + 50, self.screen_height//2))],
        [(pygame.transform.scale(pygame.image.load(os.path.join(self.image_folder, 'HD.png')), (self.screen_width//3, self.screen_height//3)), (self.screen_width//6 - 50, self.screen_height//4)),  
        (pygame.transform.scale(pygame.image.load(os.path.join(self.image_folder, 'HD.png')), (self.screen_width//3, self.screen_height//3)), (self.screen_width//2 + 50, self.screen_height//2))]]

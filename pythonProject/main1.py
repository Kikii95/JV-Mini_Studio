...
pygame.display.set_caption('Game L1')
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if not inventory.inv_open:
                ...
                if event.key == pygame.K_SPACE and player.in_air:
                    ...
                    gliding = False
                # Album/Text hotkeys
                if event.key == pygame.K_a: run_external_script("Album1.py")
                if event.key == pygame.K_p: run_external_script("text1.py")
